      ...
      body: BlocBuilder<ThemeCubit, ThemeState>(
        builder: (context, state) => ListView(
          ...
          children: [
            ...
            const SettingsSectionHeaderWidget(label: 'Brightness mode'),
            const SettingsThemePickerWidget(),
            SizedBox(height: 20.h),
            const SettingsSectionHeaderWidget(label: 'Presets'),
            _PresetPicker(active: state.effectiveSource),
            SizedBox(height: 20.h),
            const SettingsSectionHeaderWidget(label: 'Source'),
            _SourcePicker(active: state.effectiveSource),
            SizedBox(height: 20.h),
            const SettingsSectionHeaderWidget(label: 'Preview'),
            const _PreviewChips(),
          ],
        ),
      ),
