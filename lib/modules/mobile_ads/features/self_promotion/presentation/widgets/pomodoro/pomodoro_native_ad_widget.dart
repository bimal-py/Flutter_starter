...
class PomodoroNativeAdWidget extends StatelessWidget {
  const PomodoroNativeAdWidget({super.key});

  @override
  Widget build(BuildContext context) =>
      const SelfPromotionNativeCard(app: SelfPromotionApps.pomodoro);
}
